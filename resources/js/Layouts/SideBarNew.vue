<template>
  <div class="flex min-h-screen">
    <TransitionRoot :show="sidebarOpened">
      <Dialog as="div" class="fixed inset-0 z-40 md:hidden" @close="sidebarOpened = false">
        <TransitionChild
        ...
        >
          <div class="flex relative z-10 flex-col w-72 h-full bg-gray-50 border-r border-gray-200 md:hidden">
            <button
              ...
              type="button"
              value="Close sidebar" @click="sidebarOpened = false"
            >
              <XIcon class="w-5 h-5" />
            </button>
            ...
            <div class="overflow-y-auto flex-1">
              <div class="mb-10">
                ...
                <a
                  ...
                  :key="index" :href="item.href" class="flex items-center px-6 py-2.5 text-gray-500 hover:text-orange-600 group"
                >
                  <component
                    :is="item.icon"
      ...
      <div class="flex justify-between py-3 px-3 md:px-6 space-x-3 md:space-x-6 bg-gray-50 border-b">
        <div class="flex items-center flex-1">
          <button
            ...
            type="button"
            value="Open sidebar" @click="sidebarOpened = true"
          >
